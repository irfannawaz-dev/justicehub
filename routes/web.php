...
Route::middleware(['auth', 'hub.scope', 'can.write'])->group(function () {
    ...
    Route::post('/cases/{case}/link-las', [CaseController::class, 'linkLasCandidate'])->name('cases.link-las');
    ...
    Route::get('/services/adr-complaints', [ServiceController::class, 'adrComplaints'])->name('services.adr-complaints');
    ...
    // ── Workload Capacity ──────────────────────────────────────────────
    Route::post('/settings/capacity', [SettingsController::class, 'updateCapacity'])->name('settings.capacity.update');
